You are reviewer A1 (Performance & Hot Path), round 3 — the MANDATORY STRESS ROUND.
...
1. Your rubric: `/data/linjiashu/Code/pto-dev-folder/.cursor/agent/architecture-review-enhancement/aspects.md` → section "A1. Performance & Hot Path".
...
7. Your own round-1 and round-2 reviews: `/data/linjiashu/Code/pto-dev-folder/docs/pypto-runtime-design/reviews/2026-04-18-171357/round-1/reviews/A1-performance.md`, `/data/linjiashu/Code/pto-dev-folder/docs/pypto-runtime-design/reviews/2026-04-18-171357/round-2/reviews/A1-performance.md`.
...
9. Scenarios for replay (you MUST attach at least one to each stress-attack): focus on 6.1.1 (Single-Node Hierarchical Kernel Execution) + 6.2.1 (AICore Hang). Scenario doc: `/data/linjiashu/Code/pto-dev-folder/docs/pypto-runtime-design/06-scenario-view.md`.
...
- Write your report to EXACTLY this path: `/data/linjiashu/Code/pto-dev-folder/docs/pypto-runtime-design/reviews/2026-04-18-171357/round-3/reviews/A1-performance.md`
...
- Return a one-line confirmation: `WROTE /data/linjiashu/Code/pto-dev-folder/docs/pypto-runtime-design/reviews/2026-04-18-171357/round-3/reviews/A1-performance.md`.
